...
class AssistiveEnv(gym.Env):
    def __init__(self, robot=None, human=None, task='', obs_robot_len=0, obs_human_len=0, time_step=0.02, 
                frame_skip=5, render=False, gravity=-9.81, seed=1001, noisy = False, random_noise = False):
        self.task = task
